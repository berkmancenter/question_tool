...
exports.default = function (context) {
  ...
  function reportError(node, propertyName) {
    context.report(node, 'Template callback assignment with "' + propertyName + '" is deprecated. Use "on' + capitalizeFirstLetter(propertyName) + '" instead' // eslint-disable-line max-len
    );
  }
