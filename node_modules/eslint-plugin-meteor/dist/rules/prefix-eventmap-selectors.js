...
exports.default = function (context) {
  ...
  var _context$options$ = _context$options[0];
  var prefix = _context$options$ === undefined ? 'js-' : _context$options$;
  var _context$options$2 = _context$options[1];
  var mode = _context$options$2 === undefined ? 'relaxed' : _context$options$2;
