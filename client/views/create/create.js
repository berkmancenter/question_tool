...
Template.create.events({
  ...
  "click .instancemodsplus": function(event, template) {
    ...
    if (spacers.length < 4) {
      ...
      $(
        '<input class="instancemodsinput lastmodinput" type="text" placeholder="Moderator email..."><div class="emptyinputspacer lastinputspacer"><div class="plusbuttoncontainer"><div class="instancemodsplus">+</div></div></div>'
      )
        .insertAfter(".lastinputspacer")
        .last();
      $(".lastinputspacer")
        .first()
        .removeClass("lastinputspacer");
    ...
    Meteor.call(
      ...
      (error, result) => {
        ...
        if (typeof result === "object") {
          ...
          const errorCodes = {
            tablename:
              "Please enter a valid instance name using only letters, spaces and numbers", // Updated the error message for tablename
            threshold:
              "Please enter a valid # of 'featured' questions using the drop down menu.",
            new_length:
              "Please enter a valid value using the 'new questions' drop down menu.",
            stale_length:
              "Please enter a valid value using the 'old questions' drop down menu.",
            description:
              "Please enter a valid description under 255 characters.",
            moderators:
              "You have entered too many moderators. Please try again."
          };
          // Alert the error!
        ...
        window.location.href =
          Iron.Location.get().originalUrl + "list/" + result;
      }
    );
  },
