    ...
    Meteor.call("editadv", table._id, newValues, (error, result) => {
      if (error) {
        const errorCodes = {
          ...
          new_length:
            "Please enter a valid value in the 'New questions are highlighted for' drop down menu.",
          stale_length:
            "Please enter a valid value in the 'Old questions are highlighted after' drop down menu.",
          max_question:
            "Please enter a valid value in the 'Question max word count' drop down menu.",
          max_response:
            "Please enter a valid value in the 'Response max word count' drop down menu.",
          hidden:
            "Please enter a valid value in the 'visibility of instance' drop down menu.",
          social:
            "Please enter a valid value in the 'Social media sharing' drop down menu.",
          anonymous:
            "Please enter a valid value in the 'Allow anonymous' drop down menu."
        };
        ...
        if (isList) {
          window.location.href =
            "/list/" + Instances.findOne({ _id: table._id }).slug;
        } else {
